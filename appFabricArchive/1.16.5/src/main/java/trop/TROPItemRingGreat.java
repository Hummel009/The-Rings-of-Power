...
public class TROPItemRingGreat extends TROPItemRingBase {
	...
	public void appendTooltip(ItemStack itemStack, World world, List<Text> list, TooltipContext tooltipContext) {
		for (StatusEffect statusEffect : new StatusEffect[]{StatusEffects.INVISIBILITY}) {
	...
	public void inventoryTick(ItemStack itemStack, World world, Entity entity, int i, boolean b) {
		if (entity instanceof LivingEntity) {
			((LivingEntity) entity).addStatusEffect(new StatusEffectInstance(StatusEffects.INVISIBILITY, 20));
		}
	}
