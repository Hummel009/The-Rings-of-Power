...
public class TROPItemRingDwarf extends Item {
	...
	public void inventoryTick(ItemStack itemstack, World world, Entity entity, int par4, boolean par5) {
		if (entity instanceof LivingEntity) {
			((LivingEntity) entity).addPotionEffect(new EffectInstance(Effects.MINING_FATIGUE, 20, 2));
			((LivingEntity) entity).addPotionEffect(new EffectInstance(Effects.NIGHT_VISION, 220, 2));
		}
	}
}
