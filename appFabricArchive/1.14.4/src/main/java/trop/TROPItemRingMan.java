...
public class TROPItemRingMan extends TROPItemRingBase {
	...
	public void appendTooltip(ItemStack itemStack, World world, List<Text> list, TooltipContext tooltipContext) {
		for (StatusEffect statusEffect : new StatusEffect[]{StatusEffects.STRENGTH, StatusEffects.NIGHT_VISION}) {
	...
	public void inventoryTick(ItemStack itemStack, World world, Entity entity, int i, boolean b) {
		if (entity instanceof LivingEntity) {
			((LivingEntity) entity).addStatusEffect(new StatusEffectInstance(StatusEffects.STRENGTH, 20, 1));
			((LivingEntity) entity).addStatusEffect(new StatusEffectInstance(StatusEffects.NIGHT_VISION, 220));
		}
	}
