...
public class ItemRingDwarf extends ItemRing {
	...
	public void inventoryTick(ItemStack itemStack, Level level, Entity entity, int slot, boolean advanced) {
		if (entity instanceof LivingEntity) {
			((LivingEntity) entity).addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, 20, 1));
			((LivingEntity) entity).addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 20, 1));
		}
	}
