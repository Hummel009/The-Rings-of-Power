...
public class TROPItemRingGreat extends Item {
	...
	public void onUpdate(ItemStack itemstack, World world, Entity entity, int par4, boolean par5) {
		if (entity instanceof EntityPlayer) {
			((EntityPlayer) entity).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 200, 2));
			((EntityPlayer) entity).addPotionEffect(new PotionEffect(Potion.invisibility.id, 20, 2));
		}
	}
}
