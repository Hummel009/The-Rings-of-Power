...
public class TROPItemRingGreat extends Item {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int par4, boolean par5) {
		if (entity instanceof LivingEntity) {
			((LivingEntity) entity).addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 20, 2));
			((LivingEntity) entity).addEffect(new MobEffectInstance(MobEffects.INVISIBILITY, 20, 2));
		}
	}
}
