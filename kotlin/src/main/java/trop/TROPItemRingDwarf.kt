...
class TROPItemRingDwarf : TROPItemRingBase() {
	override fun inventoryTick(itemstack: ItemStack, world: Level, entity: Entity, par4: Int, par5: Boolean) {
		if (entity is Player) {
			entity.addEffect(MobEffectInstance(MobEffects.DIG_SPEED, 20, 2))
			entity.addEffect(MobEffectInstance(MobEffects.NIGHT_VISION, 220, 2))
		}
	}
